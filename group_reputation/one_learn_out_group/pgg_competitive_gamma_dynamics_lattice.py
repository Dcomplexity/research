...
if __name__ == '__main__':
    ...
    for r in gamma_l:
        print(r)
        adj_link, edge = generate_lattice(8, 4)
        group_c_frac_history = dynamic_process(m, n, c, r, mu, run_time, init_type, adj_link, edge)
    ...
    csv_file_name = './results_old/pgg_competitive_gamma_dynamics_lattice.csv'
