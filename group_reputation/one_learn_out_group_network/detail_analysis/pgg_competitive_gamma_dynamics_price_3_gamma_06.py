...
def generate_price(n, m, r):
    ...
    nx.write_gpickle(g_network, "./network_structure/price_3_gamma_06.gpickle")
...
if __name__ == '__main__':
    ...
    init_type = 'homo'
    gamma_l = np.round(np.arange(0.6, 0.61), 2)
    ...
    for r_value in [3]:
        ...
        for gamma in gamma_l:
            ...
            group_c_frac_history = dynamic_process(g_n, g_s, c, gamma, mu, run_time, init_type, adj_link, edge)
