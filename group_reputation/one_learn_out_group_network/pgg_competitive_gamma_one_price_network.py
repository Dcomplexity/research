...
if __name__ == '__main__':
    ...
    for r_value in [2, 2.5, 3, 5]:
        ...
        csv_file_name_simulation = './results/pgg_competitive_gamma_simulation_one_price_network_%.1f.csv' % r_value
        gamma_frac_history_simulation_pd.to_csv(csv_file_name_simulation)
        csv_file_name_dynamics = './results/pgg_competitive_gamma_dynamics_one_price_network_%.1f.csv' % r_value
