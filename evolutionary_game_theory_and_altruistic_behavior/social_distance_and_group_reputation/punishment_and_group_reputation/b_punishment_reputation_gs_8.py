...
def run_game(ind_strategy, ind_rep, defect_param, group_size, group_base, group_length,
             total_num, ind_pos, pos_ind, rt, rq, punishment_cost):
...
if __name__ == "__main__":
    ...
    file_name = dir_name + 'frac_co_b_punishment_reputation_gs_%s.csv' % group_size_r
    f = open(file_name, 'w')
    ...
    for defect_param_r in defect_param_r_list:
        ...
        for round_index in range(rounds):
            ...
            for step_i in range(run_time):
                ind_strategy_r, ind_rep_new_r = run_game(ind_strategy_r, ind_rep_r, defect_param_r, group_size_r,
                                                         group_base_r, group_length_r, total_num_r, ind_pos_r,
                                                         pos_ind_r, rt_r, rq_r, punishment_cost_r)
