...
def run_game(ind_strategy, defect_param, total_num, ind_pos):
...
if __name__ == '__main__':
    ...
    file_name = dir_name + 'frac_co_b_original_gs_%s.csv' % group_size_r
    f = open(file_name, 'w')
    ...
    for defect_param_r in defect_param_r_list:
        ...
        for round_index in range(rounds):
            ...
            for step_i in range(run_time):
                ind_strategy_r = run_game(ind_strategy_r, defect_param_r, total_num_r, ind_pos_r)
            sample_strategy = []
