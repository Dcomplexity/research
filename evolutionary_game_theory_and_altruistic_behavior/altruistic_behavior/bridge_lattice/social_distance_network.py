...
def generate_network_my_type(mul_dimen, degree, group_size, group_base, group_length, dimen_l, alpha):
...
def generate_network_my_type_connected(mul_dimen, degree, group_size, group_base, group_length, dimen_l, alpha):
    adj_link = generate_network_my_type(mul_dimen, degree, group_size, group_base, group_length, dimen_l, alpha)
    G = nx.Graph(adj_link)
    gen_num = 0
...
if __name__ == "__main__":
    ...
    G_r = generate_network_my_type_connected(mul_dimen_r, degree_r, group_size_r, group_base_r, group_length_r, dimen_l_r, alpha_r)
