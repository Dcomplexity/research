...
def imitation_process(popu, edge, r=3, s=0, t=5, p=1, b=1, game_type=None):
    total_num = len(popu)
...
def run_imitation_process(popu_size, adj_link, edge, run_time, sample_time, r=3, s=0, t=5, p=1, b=1, game_type=None):
    popu = initialize_population(popu_size, adj_link)
    for _ in range(run_time):
        print(_)
        popu = imitation_process(popu, edge, r, s, t, p, b, game_type)
        for i in range(popu_size):
...
if __name__ == '__main__':
    ...
    run_time = 10000
    sample_time = 200
    r = 3; s = 0; t = 5; p = 1; b = 0.7
    adj_link, edge = generate_well_mixed_network(popu_size)
    game_type = 'pd_b'
    run_imitation_process(popu_size, adj_link, edge, run_time, sample_time, r, s, t, p, b, game_type)
