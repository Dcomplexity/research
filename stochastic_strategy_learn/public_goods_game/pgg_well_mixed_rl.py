...
def initialize_population():
    ...
    for i in range(total_num):
        popu.append(Agent(agent_id=i, action_num=a_num, link=network[i], gradient=True))
...
def rl_in_pgg(popu, total_num, edges, r, eval=False):
    ...
    for i in range(total_num):
        ...
        r_group_l = play_pgg_game(a_group, enhancement_factor)
...
def evaluation(popu, edges, r, sample_time):
    ...
    for _ in range(sample_time):
        popu, co_frac = rl_in_pgg(popu, total_num, edges, r, eval=True)
...
if __name__ == '__main__':
    ...
    simulation_name = "pgg_well_mixed_rl"
